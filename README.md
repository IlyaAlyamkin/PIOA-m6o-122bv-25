...
![Структура проекта:](image.png)  
                                          ...
                                          Назначение модулей:
backend/memory.py - содержит определение типа записи StudentRecord (кортеж из пяти полей: id, имя, фамилия, возраст, пол), саму таблицу Student (список записей) и функции для работы с данными:
